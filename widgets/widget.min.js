...
$(document).delegate('svg[data-widget="icon.light"]',{update:function(d,a){var b=Math.round(a[0]/$(this).attr("data-max")*10),c=1;$("#"+this.id+" g#light-rays line").each(function(){b>=c?$(this).css("visibility","visible"):$(this).css("visibility","hidden");c++})}});$(document).delegate('svg[data-widget="icon.volume"]',{update:function(d,a){var b=Math.round(a[0]/$(this).attr("data-max")*71);fx.bar(this,b,[18,68],[89,50])}}); 
