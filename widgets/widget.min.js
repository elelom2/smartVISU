...
$(document).delegate('svg[data-widget="icon.zenith"]',{update:function(d,a){var b=a[0]/$(this).attr("data-max")*Math.PI;pt=fx.rotate([10,90],b,[50,90]);$("#"+this.id+" #sun").attr("x",pt[0]-50);$("#"+this.id+" #sun").attr("y",pt[1]-50)}}); 
