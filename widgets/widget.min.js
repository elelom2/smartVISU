...
0;a.shadowOffsetY=0;a.shadowBlur=0;a.fillStyle="#555";a.arc(139,139,138,0,2*Math.PI,!1);a.fill();for(var h,m=0;m<=d;m++){var k=e+m*c,n=1,p=m*g;for(h=b;100>=h;h+=b)a.beginPath(),a.fillStyle=fx.hsv2rgb(p,100,h),a.arc(139,139,n*f+f+1,k,k+c+.01,!1),a.arc(139,139,n*f,k+c+.01,k,!0),a.fill(),n+=1;for(h=100-b;h>=b;h-=b)a.beginPath(),a.fillStyle=fx.hsv2rgb(p,h,100),a.arc(139,139,n*f+f+1,k,k+c+.01,!1),a.arc(139,139,n*f,k+c+.01,k,!0),a.fill(),n+=1}--m;k=e+m*c;n=1;p=m*g;for(h=b;100>=h;h+=b/2)a.beginPath(),a.fillStyle=
fx.hsv2rgb(p,0,h),a.arc(139,139,n*f+f+1,k,k+2*c+.01,!1),a.arc(139,139,n*f,k+2*c+.01,k,!0),a.fill(),n+=1;a.beginPath();a.fillStyle="rgb(0,0,0)";a.arc(139,139,f+1,0,2*Math.PI,!1);a.fill()}},click:function(d){var a=this.id.substr(0,this.id.length-5),b=$(this)[0].getContext("2d"),c=$(this).offset(),e=Math.round(d.pageX-c.left);d=Math.round(d.pageY-c.top);b=b.getImageData(e,d,1,1).data;e=$("#"+a).attr("data-max");d=$("#"+a).attr("data-item").explode();io.write(d[0],Math.round(b[0]/255*e));io.write(d[1],
...
$(document).delegate('div[data-widget="plot.multiaxis"]',{update:function(d,a){var b=[];$(this).attr("data-ymin")&&(b=$(this).attr("data-ymin").explode());var c=[];$(this).attr("data-ymax")&&(c=$(this).attr("data-ymax").explode());var e=$(this).attr("data-label").explode(),f=$(this).attr("data-color").explode(),g=$(this).attr("data-exposure").explode(),h=$(this).attr("data-axis").explode(),m=$(this).attr("data-zoom"),k=[];$(this).attr("data-assign")&&(k=$(this).attr("data-assign").explode());var n=
[];$(this).attr("data-opposite")&&(n=$(this).attr("data-opposite").explode());var p=[];$(this).attr("data-ycolor")&&(p=$(this).attr("data-ycolor").explode());for(var q=[],r=[],l=0,l=0;l<a.length;l++)q[l]={type:"stair"!=g[l]?g[l]:"line",step:"stair"==g[l]?"left":!1,name:e[l],data:a[l],color:f[l]?f[l]:null,yAxis:k[l]?k[l]-1:0};for(l=0;l<h.length-1;l++)r[l]={min:b[l]?b[l]:null,max:c[l]?c[l]:null,title:{text:h[l+1]},opposite:0<n[l],minPadding:.05,maxPadding:.05,endOnTick:!1,startOnTick:!1},p[l]&&(r[l].lineColor=
p[l],r[l].tickColor=p[l]);m?$("#"+this.id).highcharts({chart:{zoomType:"x"},series:q,xAxis:{type:"datetime",title:{text:h[0]},minRange:(new Date).duration(m).valueOf()},yAxis:r}):$("#"+this.id).highcharts({series:q,xAxis:{type:"datetime",title:{text:h[0]}},yAxis:r})},point:function(d,a){var b=$(this).attr("data-count");1>b&&(b=100);for(var c=0;c<a.length;c++)if(a[c]){for(var e=$("#"+this.id).highcharts(),f=0;f<a[c].length;f++)e.series[c].addPoint(a[c][f],!1,e.series[c].data.length>=b);e.redraw()}}});
$(document).delegate('div[data-widget="plot.period"]',{update:function(d,a){for(var b=$(this).attr("data-label").explode(),c=$(this).attr("data-color").explode(),e=$(this).attr("data-exposure").explode(),f=$(this).attr("data-axis").explode(),g=$(this).attr("data-zoom"),h=[],m=0;m<a.length;m++)h[m]={type:"stair"!=e[m]?e[m]:"line",step:"stair"==e[m]?"left":!1,name:b[m],data:a[m],color:c[m]?c[m]:null};g?$("#"+this.id).highcharts({chart:{zoomType:"x"},series:h,xAxis:{type:"datetime",title:{text:f[0]},
...
$(document).delegate('div[data-widget="plot.stacked"]',{update:function(d,a){var b=$(this).attr("data-label").explode(),c=$(this).attr("data-color").explode(),e=$(this).attr("data-exposure").explode(),f=$(this).attr("data-axis").explode();$(this).attr("data-zoom");for(var g=JSON.parse($(this).attr("data-stacklabels")),h=JSON.parse($(this).attr("data-correctdate")),m=[],k=0;k<a.length;k++){for(var n=a[k],p=0;p<n.length;p++){var q=n[p][0];h&&(q-=864E5);n[p][0]=(new Date(q)).setHours(0,0,0,0)}n.pop();
a[k]=n;m[k]={type:"stair"!=e[k]?e[k]:"line",step:"stair"==e[k]?"left":!1,name:b[k],data:a[k],color:c[k]?c[k]:null}}$("#"+this.id).highcharts({chart:{type:"column"},series:m,xAxis:{type:"datetime",title:{text:f[0]}},yAxis:{min:$(this).attr("data-ymin"),max:$(this).attr("data-ymax"),title:{text:f[1]},stackLabels:{enabled:g,formatter:function(){return parseFloat(this.total).toFixed(2)},style:{color:"#fff","font-size":"13px","line-height":"14px"}}},plotOptions:{column:{stacking:"normal",dataLabels:{enabled:!1}}},
tooltip:{valueDecimals:2}})},point:function(d,a){var b=$(this).attr("data-count");1>b&&(b=100);for(var c=0;c<a.length;c++)if(a[c]){for(var e=$("#"+this.id).highcharts(),f=0;f<a[c].length;f++)e.series[c].addPoint(a[c][f],!1,e.series[c].data.length>=b);e.redraw()}}});
$(document).delegate('div[data-widget="plot.minmaxavg"]',{update:function(d,a){for(var b=$(this).attr("data-axis").explode(),c=$(this).attr("data-unit"),e=0;e<a.length;e++){var f=a[e];f.pop();f.pop();for(var g=0;g<f.length;g++)f[g][0]=(new Date(f[g][0])).setHours(0,0,0,0)}f=[];for(e=0;e<a[0].length;e++)f[e]=[a[0][e][0],a[0][e][1],a[1][e][1]];$("#"+this.id).highcharts({chart:{type:"columnrange",inverted:!1},series:[{data:f,enableMouseTracking:!1},{type:"line",data:a[2]}],xAxis:{type:"datetime",title:{text:b[0]}},
yAxis:{min:$(this).attr("data-ymin"),max:$(this).attr("data-ymax"),title:{text:b[1]}},plotOptions:{columnrange:{dataLabels:{enabled:!0,formatter:function(){return""!=c?parseFloat(this.y).transUnit(c):parseFloat(this.y).transFloat()}}}},tooltip:{pointFormatter:function(){var a=this.y,a=""!=c?parseFloat(this.y).transUnit(c):parseFloat(this.y).transFloat();return'<span style="color:'+this.color+'">\u00d8</span>  <b>'+a+"</b><br/>"}},legend:{enabled:!1}})},point:function(d,a){var b=$(this).attr("data-count");
1>b&&(b=100);for(var c=a[0],e=a[1],f=0;f<c.length;f++){var g=$("#"+this.id).highcharts();g.series[0].addPoint([(new Date(c[f][0])).setHours(0,0,0,0),c[f][1],e[f][1]],!1,g.series[f].data.length>=b);g.series[1].addPoint([(new Date(a[2][f][0])).setHours(0,0,0,0),a[2][f][1]],!1,g.series[f].data.length>=b);g.redraw()}}});
$(document).delegate('svg[data-widget="icon.light"]',{update:function(d,a){var b=Math.round(a[0]/$(this).attr("data-max")*10),c=1;$("#"+this.id+" g#light-rays line").each(function(){b>=c?$(this).css("visibility","visible"):$(this).css("visibility","hidden");c++})}});$(document).delegate('svg[data-widget="icon.zenith"]',{update:function(d,a){var b=a[0]/$(this).attr("data-max")*Math.PI;pt=fx.rotate([10,90],b,[50,90]);$("#"+this.id+" #sun").attr("x",pt[0]-50);$("#"+this.id+" #sun").attr("y",pt[1]-50)}}); 
